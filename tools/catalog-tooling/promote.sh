...
printf '%s\n' "${SOURCE_REF}" > "${DIST_DIR}/catalog-tooling.promote.source.ref"
printf '%s\n' "${PINNED_REF}" > "${DIST_DIR}/catalog-tooling.promote.digest.ref"
printf '%s\n' "${TARGET_REF}" > "${DIST_DIR}/catalog-tooling.promote.target.ref"
